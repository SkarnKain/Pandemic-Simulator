...
function menu_delai_immun() {
    ...
    stroke(255, 0, 0);
    textSize(20);
    text("Conservation de l'immunité après rémission", delai_immun_menu_pos[0] - 10, delai_immun_menu_pos[1] - 35);

    fill(150);
    noStroke();
    textSize(15);
    textAlign(RIGHT);
    text("Taille : ", delai_immun_menu_pos[0] - 100, delai_immun_menu_pos[1]);
    textAlign(LEFT);
    fill(255);
    text(slider_delai_immun.value() + " jours", delai_immun_menu_pos[0] + 110, delai_immun_menu_pos[1]);
